...
exp_name = "Fepv0_2_1000epochs" #"no_SAC_fepv0_1"  "Tworrv0_27" #"no_SAC_0_9"
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=700, replay_size=1000000, gamma=0.99, polyak=0.995,
