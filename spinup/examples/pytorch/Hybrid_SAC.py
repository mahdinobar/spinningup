...
exp_name = "no_SAC_v07_3" #"no_SAC_fepv0_3" return is 9.81 "no_SAC_fepv0_1"  "Tworrv0_27" #"no_SAC_0_9"
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=3, replay_size=1000000, gamma=0.99, polyak=0.995,
            lr=0.005, alpha=0.2, batch_size=100, start_steps=99, update_after=99, update_every=1, num_test_episodes=2,
