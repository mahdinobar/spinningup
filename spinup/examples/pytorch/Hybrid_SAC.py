...
exp_name = "Fepv0_15_lr0001_15000epochs_lp160_separated_pose_errors_qinitnoisy_noisy_target_action30percent"
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=15000, replay_size=1000000, gamma=0.99, polyak=0.995,
