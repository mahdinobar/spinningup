...
# exp_name = "draft_HW_5_NOSAC" #this must include Fep, correct code in e.g. test_policy.py line 131
exp_name = "Fep_HW_5" #this must include Fep, correct code in e.g. test_policy.py line 131
Euler_server=False
XPS_laptop=True
