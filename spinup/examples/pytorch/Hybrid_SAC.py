...
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=5000, replay_size=1000000, gamma=0.99, polyak=0.995,
            lr=0.005, alpha_init=0.001, batch_size=100, start_steps=10000, update_after=10000, update_every=100, num_test_episodes=2,
