...
exp_name = "Fepv0_8_10_4times256hiddenlayersPiQ_longer"
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=500, replay_size=1000000, gamma=0.99, polyak=0.995,
            lr=0.005, alpha=0.05, batch_size=100, start_steps=1000, update_after=1000, update_every=100, num_test_episodes=2,
