...
exp_name = "Fepv0_13_TargetEntropy0001times_longer"
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=10000, replay_size=1000000, gamma=0.99, polyak=0.995,
