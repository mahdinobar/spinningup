...
# exp_name = "draft_HW_3_NOSAC" #this must include Fep, correct code in e.g. test_policy.py line 131
...
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=136, epochs=5000, replay_size=1360000, gamma=0.99, polyak=0.995,
            lr=0.001, alpha_init=0.001, batch_size=136, start_steps=13600, update_after=136000, update_every=136, num_test_episodes=2,
