...
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        #     lr=0.001, alpha_init=0.1, batch_size=136, start_steps=136, update_after=136, update_every=136, num_test_episodes=2,
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=136, epochs=5, replay_size=1360000, gamma=0.99, polyak=0.995,
                ...
                max_ep_len=np.inf, logger_kwargs=logger_kwargs, save_freq=1, initial_actions="random", save_buffer=True, sample_mode = 1, automatic_entropy_tuning=True, load_checkpoint_switch=True)
    else:
