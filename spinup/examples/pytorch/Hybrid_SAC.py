...
# exp_name = "draft_HW_3b_NOSAC" #this must include Fep, correct code in e.g. test_policy.py line 131
exp_name = "Fep_HW_9"
Euler_server=False
XPS_laptop=True
if __name__ == '__main__':
    ...
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=136, epochs=10000, replay_size=1360000, gamma=0.99, polyak=0.995,
