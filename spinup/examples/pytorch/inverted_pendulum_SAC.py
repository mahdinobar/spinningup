...
if __name__ == '__main__':
    if TRAIN:
        ...
        sac(env_fn, ac_kwargs={}, seed=0, steps_per_epoch=100, epochs=100, replay_size=1000, gamma=0.99, polyak=0.995, lr=0.001, alpha=0.2, batch_size=10, start_steps=100, update_after=100, update_every=50, num_test_episodes=2, max_ep_len=100, logger_kwargs=logger_kwargs, save_freq=1)
    if DEBUG:
