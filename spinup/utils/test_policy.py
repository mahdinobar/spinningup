...
def load_pytorch_policy(fpath, itr, deterministic=False):
    ...
    def get_action(x):
        ...
        with torch.no_grad():
            ...
            # traced_model_Cpp.save("/home/mahdi/ETHZ/codes/spinningup/spinup/examples/pytorch/logs/Fep_HW_314/traced_model_Cpp_Fep_HW_314_double.pt")
        return action
    ...
    while n < num_episodes:
        ...
        if d or (ep_len == max_ep_len):
            ...
            if num_episodes ==1:
                ...
                # np.save(output_dir + "/PIstar_plot_data_buffer_episode_{}".format(str(n)), env.unwrapped.plot_data_buffer)
                # np.save(output_dir + "/PIstar_correct_pinvJ_loopshaping_{}".format(str(n)), env.unwrapped.plot_data_buffer)
                if n==num_episodes-1:
                    env.render(output_dir)
            n += 1
